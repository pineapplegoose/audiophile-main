...
export const ProductAds = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center pb-24 bg-white">
            <motion.div
                className="flex relative px-[118px] w-[1110px] mb-12 overflow-hidden rounded-lg pt-24 bg-[#D87D4A]"
            ...
            >
                ...
                <div className="flex z-10">
                    ...
                    <div className="w-[349px] ml-[138px]">
                        ...
                        <Link key={id1} href={`/products/${id1}`}><button className="bg-black hover:bg-[#FBAF85] hover:cursor-pointer text-[13px] font-bold uppercase w-40 h-12">See Product</button></Link>
                    </div>
                </div>
            </motion.div>

            <motion.div
                className='flex px-2.5 mb-12 overflow-hidden rounded-lg pt-24 relative w-[1110px] h-80'
            ...
            >
                <div className='z-10 w-[400px] ml-[95px]'>
                    ...
                    <Link key={id2} href={`/products/${id2}`}><button className="bg-transparent border border-black hover:cursor-pointer text-black text-[13px] font-bold uppercase w-40 h-12">See Product</button></Link>
                </div>
            ...
            <div className="flex w-[1110px] relative mb-[200px] overflow-hidden rounded-lg pt-0">
                ...
                />
                <motion.div
                    className='bg-[#F1F1F1] rounded-lg pl-[95px] py-[101px] z-10 w-[540px] ml-[30px]'
                    initial={{ opacity: 0, x: 50 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    viewport={{ once: true, margin: '-50px' }}
                ...
                >
                    ...
                    <Link key={id3} href={`/products/${id3}`}><button className="bg-transparent border border-black hover:cursor-pointer text-black text-[13px] font-bold uppercase w-40 h-12">See Product</button></Link>
                </motion.div>
            </div>
        </div>
    )
